...
sales as (
	...
	JOIN 
		...
		and d.sbis_shipment_date>='2025-01-01 00:00:00'
		and d.sbis_shipment_date<CONCAT(CURDATE() - INTERVAL 1 DAY, ' 23:59:59')
		and(d.shipment = 1)
	...
	FROM 
		documents d
	where d.sbis_shipment_date>='2025-01-01 00:00:00'
		and d.sbis_shipment_date<CONCAT(CURDATE() - INTERVAL 1 DAY, ' 23:59:59')
		and(d.shipment = 1) 
		and(d.invoice_total_sum_calculated>0)
		and(d.deleted =0)
